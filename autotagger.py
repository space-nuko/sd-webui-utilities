...
parser_single.add_argument('--threshold', '-t', default=DEFAULT_THRESHOLD, type=float, help="Minimum tag confidence (0.0-1.0), lower == more tags")
...
parser_batch.add_argument('--threshold', '-t', default=DEFAULT_THRESHOLD, type=float, help="Minimum tag confidence (0.0-1.0), lower == more tags")
